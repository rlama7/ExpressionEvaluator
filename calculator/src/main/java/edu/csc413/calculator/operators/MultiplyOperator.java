/**
 * MultiplyOperator.java     --A program to represent multiplication operator.
 * @author                  Ratna Lama
 * @version                 1.0
 * @since                   09/17/2018
 */
...
public class MultiplyOperator extends Operator {
    ...
    /**
     * Executes multiplication operation on two operands
     * @param op1   operand one
     * @param op2   operand two
     * @return Operand  result of multiplication on operand one and operand two
     */
