/**
 * AddOperator.java     --A program to represent addition operator.
 * @author              Ratna Lama
 * @version             1.0
 * @since               09/17/2018
 */
...
public class AddOperator extends Operator {
    ...
    /**
     * Executes addition operation on two operands
     * @param op1   operand one
     * @param op2   operand two
     * @return Operand  result of addition on operand one and operand two
     */
    public Operand execute(Operand op1, Operand op2 ) {
        return new Operand(op1.getValue() + op2.getValue());
    } // end execute()

} // end AddOperator Class
